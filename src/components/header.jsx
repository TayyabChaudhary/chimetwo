...
export default function Header() {
    ...
    $(document).ready(function () {
        $('#check__nav').click(function () {
            $('#mobile-menu-language-select').addClass('actives');
            return false;
        });
        $('.close__nav').click(function () {
            $('#mobile-menu-language-select').removeClass('actives');
            return false;
        });
    });
    ...
    return (
        <React.StrictMode>
            <header className='chime__main__header'>
                <div className="chime__container">
                    <div className="chime__row">
                        <div className="left__side__row">
                            <nav className="border-gray-200 fixed top-0 right-0 left-0 z-50 shadow-md px-2 sm:px-4 py-0" ref={navRef} style={{ backgroundColor: "rgba(255,255,255,.98)" }}>
                                <div className="header__container flex flex-wrap items-center justify-between mx-auto">
                                    <div className="flex items-center gap-4">
                                        <Link to={`/`} className="flex items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="20" viewBox="0 0 672 193" fill="none" data-arp-injected="true">
                                        ...
                                        <div className="items-center justify-between nav__main w-full md:flex md:w-auto md:order-1" id="mobile-menu-language-select">
                                            <ul className="flex flex-col p-4 mt-4 md:flex-row md:space-x-2 items-center md:mt-0 md:text-sm md:font-medium md:border-0">
                                                ...
                                                <li className='dropdown font-bold'>
                                                    <a href="!#" className="block py-2 pl-3 pr-4 text-gray-800 rounded">Who we are</a>
                                                    <div className="dropdown-content">
                                                        <a href="!#">About Us</a>
                                                        <a href="!#">In the News</a>
                                                        <a href="!#">Chime Financial</a>
                                                        <a href="!#">In the Communications</a>
                                                        <a href="!#">Careers</a>

                                                    </div>
                                                </li>
                                                <li className='dropdown font-bold'>
                                                    <a href="!#" className="block py-2 pl-3 pr-4 text-gray-800 rounded">Learn</a>
                                                    <div className="dropdown-content">
                                    ...
                                    <div className="flex items-center md:order-2">
                                        <button type="button" onClick={routeChangeTwo} data-dropdown-toggle="language-dropdown-menu" className="inline-flex items-center justify-center px-4 py-2 font-bold text-sm text-gray-800 rounded-lg cursor-pointer hover:text-gray-900">
                                            Log In
                                        </button>
                                        <button type="button" onClick={routeChange} data-dropdown-toggle="language-dropdown-menu" className="sign__up__btn">
                                            Sign Up
                                        </button>
                                        <button data-collapse-toggle="mobile-menu-language-select" id='check__nav' type="button" className="inline-flex items-center p-2 ml-1 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu-language-select" aria-expanded="false">
                                            <span className="sr-only">Open main menu</span>
                                            <svg className="w-6 h-6" onClick={showNavbar} fill="currentColor" aria-hidden="true" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clipRule="evenodd"></path></svg>
                                        </button>
                                    </div>
                                </div>
                            </nav>
